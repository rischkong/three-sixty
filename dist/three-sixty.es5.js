...
//    console.log( "init ES5 Listeners" );
  };
  /**
   ...
   * Goto angle
   */
  ThreeSixty.prototype.gotoAngle = function ( desiredAngle ) {
    var _this = this;
    // Calculate new image angle
    this.angle = desiredAngle;
//    this.adaptAngle( desiredAngle );
//RSK    console.log( "gotoAngleEs5 ", desiredAngle, this.angle );
    var imageIndexes = this.getImageIndexesForCurrentAngle();
//    console.log( imageIndexes );
   ...
   * Goto angle
   */
  ThreeSixty.prototype.gotoAngleWithDistance = function ( desiredAngle ) {
    var _this = this;
    // Calculate new image angle
    this.adaptAngle( desiredAngle );
    var imageIndexes = this.getImageIndexesForCurrentAngle();
   ...
   * Goto angle
   */
  ThreeSixty.prototype.getAngle = function () {
    var _this = this;
    // console.log( "getAngleEs5 ", _this.angle );
    return _this.angle;
  };
  ...
  ThreeSixty.prototype.adaptAngle = function ( distance ) {
    ...
    var tmpAngle = ((1 - (this.preDragAngle / 360)) + dx * 0.3);
    while ( tmpAngle < 0 ) {
      tmpAngle++;
    }
    tmpAngle = tmpAngle % 1;
...
//# sourceMappingURL=three-sixty.es5.js.map
